...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.ori.setGeometry(QtCore.QRect(20, 160, 250, 410))
        ...
        self.model_output.setGeometry(QtCore.QRect(280, 160, 590, 410))
        ...
        self.preprocess = QtWidgets.QVBoxLayout(self.centralwidget)
        self.preprocess.setGeometry(QtCore.QRect(20, 580, 410, 410))
        label = QtWidgets.QLabel()
        label.setFixedSize(500, 500)
        self.preprocess.addWidget(label)
        ...
        self.clear.setGeometry(QtCore.QRect(880, 880, 91, 31))
        ...
        self.header = QtWidgets.QCheckBox(self.centralwidget)
        self.header.setGeometry(QtCore.QRect(860, 130, 141, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Mn Predictor"))
        self.open.setText(_translate("MainWindow", "OPEN"))
        self.modelPath.setWhatsThis(_translate("MainWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.modelPath.setItemText(0, _translate("MainWindow", "model1 (uniform scaling)"))
        self.modelPath.setItemText(1, _translate("MainWindow", "model2 (trained without noise)"))
        self.modelPath.setItemText(2, _translate("MainWindow", "model3 (correct scaling)"))
        self.modelPath.setItemText(3, _translate("MainWindow", "model4 (fixed mean and std, correct scaling)"))
        self.modelPath.setItemText(4, _translate("MainWindow", "model5 (Used mean and std of each spectrum)"))
        self.modelPath.setItemText(5, _translate("MainWindow", "model6 (Increased Mn metal appearance)"))
        self.modelPath.setItemText(6, _translate("MainWindow", "model7_1 (no metal)"))
        self.modelPath.setItemText(7, _translate("MainWindow", "model8_1 (with metal)"))
        ...
        self.load.setText(_translate("MainWindow", "PREDICT"))
